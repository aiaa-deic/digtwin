...
If you would like to get involved with the Subcommittee, contact [Jay Ganguli](mailto:jayendra.ganguli@rtx.com).
...
and is created based on the source code found in the repository located <https://github.com/aiaa-deic/digtwin>.
...
to raise an [issue](https://github.com/aiaa-deic/digtwin/issues) in the repository
...
As above, if you have any problems, please raise an [issue](https://github.com/aiaa-deic/digtwin/issues).
...
If you have any trouble contributing to this site or have any technical questions, feel free to take either of the following actions:

- contact [Josh Haines](mailto:Josh@JoshHaines.com) directly
- raise an [issue](https://github.com/aiaa-deic/digtwin/issues) in the repository and put `@jdhaines` somewhere in the text.
